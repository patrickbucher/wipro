...
Nach jedem Sprint wird ein Inkrement an die Entwickler ausgeliefert (siehe \secref{sec:Vorgehen}). Die Rückmeldungen werden hier gesammelt und kommentiert ‒ und fliessen ins Backlog und nach Möglichkeit ins den jeweils nachfolgenden Sprint ein.
